...
def main():
    ...
    # accelerate settings
    accelerate_project_config = ProjectConfiguration(
    ...
    accelerator = Accelerator(
        ...
        log_with='wandb',
        project_config=accelerate_project_config,
    )
    ...
    # Scheduler
    lr_scheduler = get_scheduler(cfg.lr_scheduler_name, optimizer=optimizer)
    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if accelerator.sync_gradients:
                ...
                # save checkpoints and lora weights
